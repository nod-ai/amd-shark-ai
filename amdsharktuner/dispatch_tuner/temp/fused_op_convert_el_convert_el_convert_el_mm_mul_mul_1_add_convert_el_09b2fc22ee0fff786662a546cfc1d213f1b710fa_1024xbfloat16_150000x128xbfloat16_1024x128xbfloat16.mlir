module {
  func.func public @fused_op_convert_el_convert_el_convert_el_mm_mul_mul_1_add_convert_el_09b2fc22ee0fff786662a546cfc1d213f1b710fa_1024xbfloat16_150000x128xbfloat16_1024x128xbfloat16(%arg0: !torch.vtensor<[1024],bf16>, %arg1: !torch.vtensor<[150000,128],bf16>, %arg2: !torch.vtensor<[1024,128],bf16>) -> !torch.vtensor<[150000,1024],bf16> {
    %int1 = torch.constant.int 1
    %int0 = torch.constant.int 0
    %0 = torch.prim.ListConstruct %int1, %int0 : (!torch.int, !torch.int) -> !torch.list<int>
    %1 = torch.aten.permute %arg2, %0 : !torch.vtensor<[1024,128],bf16>, !torch.list<int> -> !torch.vtensor<[128,1024],bf16>
    ...
    %3 = torch.prims.convert_element_type %arg1, %int6_0 : !torch.vtensor<[150000,128],bf16>, !torch.int -> !torch.vtensor<[150000,128],f32>
    %int6_1 = torch.constant.int 6
    %4 = torch.prims.convert_element_type %1, %int6_1 : !torch.vtensor<[128,1024],bf16>, !torch.int -> !torch.vtensor<[128,1024],f32>
    %5 = torch.aten.mm %3, %4 : !torch.vtensor<[150000,128],f32>, !torch.vtensor<[128,1024],f32> -> !torch.vtensor<[150000,1024],f32>
