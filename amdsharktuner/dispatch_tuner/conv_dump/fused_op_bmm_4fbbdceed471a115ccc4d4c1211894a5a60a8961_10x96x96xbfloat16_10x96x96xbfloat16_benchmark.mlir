module {
  ...
  hal.executable private @fused_op_bmm_4fbbdceed471a115ccc4d4c1211894a5a60a8961_10x96x96xbfloat16_10x96x96xbfloat16$async_dispatch_0 {
    hal.executable.variant public @rocm_hsaco_fb target(<"rocm", "rocm-hsaco-fb", {abi = "hip", iree.encoding.resolver = #iree_gpu.gpu_encoding_resolver<>, iree_codegen.default_tuning_spec = #rocm.builtin.tuning_module<"iree_default_tuning_spec_gfx942.mlir">, iree_codegen.target_info = #iree_gpu.target<arch = "gfx942", features = "", wgp = <compute =  fp64|fp32|fp16|int64|int32|int16|int8, storage =  b64|b32|b16|b8, subgroup =  shuffle|arithmetic, dot =  dp4xi8toi32, mma = [<MFMA_F32_16x16x16_BF16>, <MFMA_F32_32x32x8_BF16>, <MFMA_F32_16x16x32_F8E5M2FNUZ>, <MFMA_F32_16x16x32_F8E5M2FNUZ_F8E4M3FNUZ>, <MFMA_F32_16x16x32_F8E4M3FNUZ>, <MFMA_F32_16x16x32_F8E4M3FNUZ_F8E5M2FNUZ>, <MFMA_F32_32x32x16_F8E5M2FNUZ>, <MFMA_F32_32x32x16_F8E5M2FNUZ_F8E4M3FNUZ>, <MFMA_F32_32x32x16_F8E4M3FNUZ>, <MFMA_F32_32x32x16_F8E4M3FNUZ_F8E5M2FNUZ>, <MFMA_I32_16x16x32_I8>, <MFMA_I32_32x32x16_I8>, <MFMA_F64_16x16x4_F64>, <MFMA_F32_16x16x4_F32>, <MFMA_F32_16x16x16_F16>, <MFMA_F32_32x32x8_F16>], subgroup_size_choices = [64], max_workgroup_sizes = [1024, 1024, 1024], max_thread_count_per_workgroup = 1024, max_workgroup_memory_bytes = 65536, max_workgroup_counts = [2147483647, 2147483647, 2147483647], max_load_instruction_bits = 128, simds_per_wgp = 4, vgpr_space_bits = 16384, dma_sizes = [32], workgroup_memory_bank_count = 32>>, ukernels = "none"}>) {
      ...
      builtin.module {
        func.func @fused_op_bmm_4fbbdceed471a115ccc4d4c1211894a5a60a8961_10x96x96xbfloat16_10x96x96xbfloat16$async_dispatch_0_batch_matmul_10x96x96x96_bf16xbf16xf32() attributes {translation_info = #iree_codegen.translation_info<pipeline = LLVMGPUTileAndFuse workgroup_size = [256, 1, 1] subgroup_size = 64, {gpu_pipeline_options = #iree_gpu.pipeline_options<prefetch_num_stages = 2, no_reduce_shared_memory_bank_conflicts = false, use_igemm_convolution = false>}>} {
          ...
          %11 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%6, %7 : tensor<10x96x96xbf16>, tensor<10x96x96xbf16>) outs(%10 : tensor<10x96x96xf32>) attrs =  {lowering_config = #iree_gpu.lowering_config<{mma_kind = #iree_gpu.mma_layout<MFMA_F32_16x16x16_BF16>, promote_operands = [0, 1], reduction = [0, 0, 0, 2], subgroup = [0, 1, 1, 0], workgroup = [1, 32, 32, 0]}>, root_op} {
  ...
  util.global private mutable @fused_op_bmm_4fbbdceed471a115ccc4d4c1211894a5a60a8961_10x96x96xbfloat16_10x96x96xbfloat16$async_dispatch_0_rocm_hsaco_fb_fused_op_bmm_4fbbdceed471a115ccc4d4c1211894a5a60a8961_10x96x96xbfloat16_10x96x96xbfloat16$async_dispatch_0_batch_matmul_10x96x96x96_bf16xbf16xf32_buffer : !hal.buffer
  util.initializer {
    ...
    util.global.store %buffer, @fused_op_bmm_4fbbdceed471a115ccc4d4c1211894a5a60a8961_10x96x96xbfloat16_10x96x96xbfloat16$async_dispatch_0_rocm_hsaco_fb_fused_op_bmm_4fbbdceed471a115ccc4d4c1211894a5a60a8961_10x96x96xbfloat16_10x96x96xbfloat16$async_dispatch_0_batch_matmul_10x96x96x96_bf16xbf16xf32_buffer : !hal.buffer
    util.return
  }
  util.func public @fused_op_bmm_4fbbdceed471a115ccc4d4c1211894a5a60a8961_10x96x96xbfloat16_10x96x96xbfloat16$async_dispatch_0_rocm_hsaco_fb_fused_op_bmm_4fbbdceed471a115ccc4d4c1211894a5a60a8961_10x96x96xbfloat16_10x96x96xbfloat16$async_dispatch_0_batch_matmul_10x96x96x96_bf16xbf16xf32(%arg0: i32) attributes {iree.abi.stub, iree.reflection = {iree.benchmark = "dispatch"}} {
    %0 = arith.index_cast %arg0 : i32 to index
    %device, %queue_affinity = hal.device.resolve on(#hal.device.affinity<@__device_0>) : !hal.device, i64
    %cmd = hal.command_buffer.create device(%device : !hal.device) mode("OneShot|AllowInlineExecution") categories(Dispatch) affinity(%queue_affinity) : !hal.command_buffer
    %fused_op_bmm_4fbbdceed471a115ccc4d4c1211894a5a60a8961_10x96x96xbfloat16_10x96x96xbfloat16$async_dispatch_0_rocm_hsaco_fb_fused_op_bmm_4fbbdceed471a115ccc4d4c1211894a5a60a8961_10x96x96xbfloat16_10x96x96xbfloat16$async_dispatch_0_batch_matmul_10x96x96x96_bf16xbf16xf32_buffer = util.global.load @fused_op_bmm_4fbbdceed471a115ccc4d4c1211894a5a60a8961_10x96x96xbfloat16_10x96x96xbfloat16$async_dispatch_0_rocm_hsaco_fb_fused_op_bmm_4fbbdceed471a115ccc4d4c1211894a5a60a8961_10x96x96xbfloat16_10x96x96xbfloat16$async_dispatch_0_batch_matmul_10x96x96x96_bf16xbf16xf32_buffer : !hal.buffer
    %c0 = arith.constant 0 : index
    %c184320 = arith.constant 184320 : index
    %c368640 = arith.constant 368640 : index
    %workgroup_x, %workgroup_y, %workgroup_z = hal.executable.calculate_workgroups device(%device : !hal.device) target(@fused_op_bmm_4fbbdceed471a115ccc4d4c1211894a5a60a8961_10x96x96xbfloat16_10x96x96xbfloat16$async_dispatch_0::@rocm_hsaco_fb::@fused_op_bmm_4fbbdceed471a115ccc4d4c1211894a5a60a8961_10x96x96xbfloat16_10x96x96xbfloat16$async_dispatch_0_batch_matmul_10x96x96x96_bf16xbf16xf32) : index, index, index
    %exe = hal.executable.lookup device(%device : !hal.device) executable(@fused_op_bmm_4fbbdceed471a115ccc4d4c1211894a5a60a8961_10x96x96xbfloat16_10x96x96xbfloat16$async_dispatch_0) : !hal.executable
    %ordinal = hal.executable.export.ordinal target(@fused_op_bmm_4fbbdceed471a115ccc4d4c1211894a5a60a8961_10x96x96xbfloat16_10x96x96xbfloat16$async_dispatch_0::@rocm_hsaco_fb::@fused_op_bmm_4fbbdceed471a115ccc4d4c1211894a5a60a8961_10x96x96xbfloat16_10x96x96xbfloat16$async_dispatch_0_batch_matmul_10x96x96x96_bf16xbf16xf32) : index
    %c1 = arith.constant 1 : index
    scf.for %arg1 = %c0 to %0 step %c1 {
      hal.command_buffer.dispatch<%cmd : !hal.command_buffer> target(%exe : !hal.executable)[%ordinal] workgroups([%workgroup_x, %workgroup_y, %workgroup_z]) bindings([
        (%fused_op_bmm_4fbbdceed471a115ccc4d4c1211894a5a60a8961_10x96x96xbfloat16_10x96x96xbfloat16$async_dispatch_0_rocm_hsaco_fb_fused_op_bmm_4fbbdceed471a115ccc4d4c1211894a5a60a8961_10x96x96xbfloat16_10x96x96xbfloat16$async_dispatch_0_batch_matmul_10x96x96x96_bf16xbf16xf32_buffer : !hal.buffer)[%c0, %c184320], 
        (%fused_op_bmm_4fbbdceed471a115ccc4d4c1211894a5a60a8961_10x96x96xbfloat16_10x96x96xbfloat16$async_dispatch_0_rocm_hsaco_fb_fused_op_bmm_4fbbdceed471a115ccc4d4c1211894a5a60a8961_10x96x96xbfloat16_10x96x96xbfloat16$async_dispatch_0_batch_matmul_10x96x96x96_bf16xbf16xf32_buffer : !hal.buffer)[%c184320, %c184320], 
        (%fused_op_bmm_4fbbdceed471a115ccc4d4c1211894a5a60a8961_10x96x96xbfloat16_10x96x96xbfloat16$async_dispatch_0_rocm_hsaco_fb_fused_op_bmm_4fbbdceed471a115ccc4d4c1211894a5a60a8961_10x96x96xbfloat16_10x96x96xbfloat16$async_dispatch_0_batch_matmul_10x96x96x96_bf16xbf16xf32_buffer : !hal.buffer)[%c368640, %c184320]
      ]) flags("None")
