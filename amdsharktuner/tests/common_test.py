...
from iree.compiler.dialects import _builtin_ops_gen, func, iree_codegen, transform  # type: ignore
...
def test_calculate_padded_dimensions(tuner_ctx: common.TunerContext) -> None:
