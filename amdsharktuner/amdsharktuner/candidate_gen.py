...
from . import common, process_utils, spec_builder
...
def generate_solutions(
    ...
    **constraint_options,
    ...
    """Generate candidate tuning configurations for a dispatch.

    Each dispatch tuner already implies a specific pipeline (e.g., VectorDistribute
    or TileAndFuse), so the pipeline is not passed as a parameter.
    """
