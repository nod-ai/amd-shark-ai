...
* Example applications in
  ['shortfin_apps'](https://github.com/nod-ai/amd-shark-ai/tree/main/shortfin/python/shortfin_apps)
...
5. Test optional features:
   ...
   * Run tests on devices other than the CPU with flags like:
     `--system amdgpu --compile-flags="--iree-hal-target-device=hip --iree-rocm-target=gfx1100"`
...
pytest tests/ --system amdgpu \
    --compile-flags="--iree-hal-target-device=hip --iree-rocm-target=gfx1100"
```
