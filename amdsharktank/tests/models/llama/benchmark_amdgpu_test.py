...
class BenchmarkLlama3_1_8B(BaseBenchmarkTest):
    def setUp(self):
        super().setUp(artifact_dir=Path("/amdshark-dev/ossci-models/llama_3_1/8b/fp16/inputs/"), dir_path_name="llama-8b")
        ...
        self.prefill_args_fp16 = {
            128: self.save_benchmarks(
                ...
                input_path=self.artifact_dir / "isl_128/prefill/prefill_args_bs4_128_stride_32",
                tensor_parallelism_size=1,
            ),
            2048: self.save_benchmarks(
                benchmark_fn="prefill_bs4",
                input_path=self.artifact_dir / "isl_2048/prefill/prefill_args_bs4_2048_stride_32",
                tensor_parallelism_size=1,
            ),
        }
        ...
        self.decode_args_fp16 = {
            128: self.save_benchmarks(
                ...
                input_path=self.artifact_dir / "isl_128/decode/decode_args_bs4_128_stride_32",
                tensor_parallelism_size=1,
            ),
            2048: self.save_benchmarks(
                benchmark_fn="decode_bs4",
                input_path=self.artifact_dir / "isl_2048/decode/decode_args_bs4_2048_stride_32",
                tensor_parallelism_size=1,
            ),
        }
